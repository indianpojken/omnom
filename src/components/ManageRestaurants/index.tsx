  ...
  return (
    <section>
      <ol className="flex flex-col gap-4">
        <li className="flex flex-col sm:flex-row rounded-md bg-amber-50 overflow-hidden text-amber-900 border-b-2 border-amber-900">
          <article className="flex flex-1 items-center gap-2 p-2 hover:bg-amber-100 transition-colors duration-500 cursor-pointer">
            <svg
            ...
            <p className="font-bold">Fredriks fina fisk-restaurang</p>
          </article>
